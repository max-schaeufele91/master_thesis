...
class MyTestCase(unittest.TestCase):
    def test_create_point(self):
        ...
        self.assertEqual(point[0], 123, "X isn't correct")
        self.assertEqual(point[1], 456, "Y isn't correct")
    ...
    def test_create_path(self):
        ...
        self.assertEqual(path[0][0][0], 107096, "X isn't correct")
        self.assertEqual(path[0][0][1], 18237, "Y isn't correct")
